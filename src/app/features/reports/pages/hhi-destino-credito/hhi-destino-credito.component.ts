...
@Component({
  selector: 'app-hhi-destino-credito',
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
  ...
  template: `
    <app-hhi-navigation activeReport="destino-credito" />
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2 lg:col-span-1">
                  <div class="kpi-card kpi-info">
                    ...
                    <div class="kpi-content">
                      <div class="kpi-header">
                        <h3 class="kpi-label">Destinos de Crédito</h3>
                        <i
                          class="pi pi-info-circle kpi-help"
                          pTooltip="Número total de destinos de crédito con cartera activa. Más destinos puede indicar mejor diversificación del propósito de los créditos."
                          tooltipPosition="top"
                        ></i>
                      </div>
                      ...
                      <p class="kpi-description">Destinos con cartera activa</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="analytics-card">
              <div class="card-header">
                ...
                <p class="section-subtitle">
                  Distribución y ranking de participación por destino de crédito
                </p>
              </div>
            ...
            <div class="analytics-card" style="margin-top: 2rem;">
              <div class="card-header">
                <h2 class="section-title">
                  ...
                  Detalle por Destino de Crédito
                </h2>
                <p class="section-subtitle">
              ...
              <div class="table-container">
                ...
                >
                    ...
                    <tr>
                      <th pSortableColumn="agencia">
                        <div class="flex align-items-center">
                          <span class="font-semibold">Destino de Crédito</span>
                  ...
                  <ng-template pTemplate="body" let-destino let-i="rowIndex">
                    <tr>
                      <td>
                        <div class="flex align-items-center gap-2">
                          ...
                          <span class="font-medium">{{ destino.agencia }}</span>
                          @if (i < 3) {
                      ...
                      <td class="text-right">
                        <span class="font-mono font-semibold amount-text">
                          {{ destino.monto | currency: 'PEN' : 'S/. ' : '1.0-2' : 'es-PE' }}
                        </span>
                      </td>
                      <td class="text-right">
                        <div class="participation-cell">
                          <div class="participation-bar">
                            <div
                              ...
                              [style.width.%]="destino.participacion"
                            ></div>
                          </div>
                          <span class="font-mono font-semibold">
                            {{ destino.participacion | number: '1.2-2' : 'es-PE' }}%
                          </span>
                        </div>
                      </td>
                      <td class="text-right">
                        <span class="font-mono">{{
                          destino.numeroOperaciones | number: '1.0-0' : 'es-PE'
                        }}</span>
                      </td>
                      <td class="text-center">
                        <span
                          ...
                          [attr.data-level]="
                            destino.participacion >= 25
                              ? 'high'
                              : destino.participacion >= 15
                                ? 'medium'
                                : 'low'
                          "
                        >
            ...
            <div class="loading-state">
              <div class="loading-content">
                ...
                <p class="loading-text">
                  Procesando datos de concentración por destino de crédito...
                </p>
              </div>
            </div>
          </section>
...
export class HHIDestinoCreditoComponent implements OnInit {
  ...
  async cargarDatos() {
    ...
    try {
      const datos = await this.carteraRepository.getHHIDestinoCredito();
  ...
  private actualizarGraficos(datos: HHIAgenciasReporte) {
    ...
    this.pieChartOptions.set({
      title: {
        text: 'Distribución por Destino de Crédito',
        left: 'center',
        textStyle: {
          fontSize: 16,
          fontWeight: 'bold',
      ...
      toolbox: {
        ...
        feature: {
          saveAsImage: {
            ...
            name: 'HHI_DestinoCredito_Distribucion',
            pixelRatio: 2,
          },
        },
        right: 20,
      ...
      toolbox: {
        ...
        feature: {
          saveAsImage: {
            show: true,
            title: 'Descargar imagen',
            name: 'HHI_DestinoCredito_Ranking',
            pixelRatio: 2,
          },
        },
        right: 20,
  ...
  getTotalOperaciones(destinos: ConcentracionAgencia[]): number {
    return destinos.reduce((total, destino) => total + destino.numeroOperaciones, 0);
  }
}
