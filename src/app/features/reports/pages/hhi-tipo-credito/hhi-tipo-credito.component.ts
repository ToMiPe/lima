...
@Component({
  ...
  template: `
    <app-hhi-navigation activeReport="tipo-credito" />
      ...
      <main class="dashboard-main">
        @if (reporte(); as datos) {
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2 lg:col-span-1">
                  <div class="kpi-card kpi-info">
                    ...
                    <div class="kpi-content">
                      <div class="kpi-header">
                        <h3 class="kpi-label">Tipos de Crédito</h3>
                        <i
                          class="pi pi-info-circle kpi-help"
                          pTooltip="Número total de tipos de crédito con cartera activa. Más tipos puede indicar mejor diversificación del producto."
                          tooltipPosition="top"
                        ></i>
                      </div>
                      ...
                      <p class="kpi-description">Tipos con cartera activa</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section class="analytics-section">
            <div class="analytics-card">
              <div class="card-header">
                ...
                <p class="section-subtitle">
                  Distribución y ranking de participación por tipo de crédito
                </p>
              </div>
            ...
            <!-- Data Table Section - SIN PAGINACIÓN -->
                    ...
                    <tr>
                      <th pSortableColumn="agencia">
                        <div class="flex align-items-center">
                          <span class="font-semibold">Tipo de Crédito</span>
                    ...
                    <tr>
                      <td>
                        <div class="flex align-items-center gap-2">
                          ...
                          <span class="font-medium">{{ tipo.agencia }}</span>
                          @if (i < 3) {
                      ...
                      <td class="text-right">
                        <span class="font-mono font-semibold amount-text">
                          {{ tipo.monto | currency: 'PEN' : 'S/. ' : '1.0-2' : 'es-PE' }}
                        </span>
                      </td>
                      <td class="text-right">
                        <div class="participation-cell">
                          <div class="participation-bar">
                            <div
                              ...
                              [style.width.%]="tipo.participacion"
                            ></div>
                          </div>
                          <span class="font-mono font-semibold">
                            {{ tipo.participacion | number: '1.2-2' : 'es-PE' }}%
                          </span>
                        </div>
                      </td>
                      <td class="text-right">
                        <span class="font-mono">{{
                          tipo.numeroOperaciones | number: '1.0-0' : 'es-PE'
                        }}</span>
                      </td>
                      <td class="text-center">
                        <span
                          ...
                          [attr.data-level]="
                            tipo.participacion >= 25
                              ? 'high'
                              : tipo.participacion >= 15
                                ? 'medium'
                                : 'low'
                          "
                        >
          ...
          <section class="hero-section">
            <div class="loading-state">
              <div class="loading-content">
                ...
                <p class="loading-text">Procesando datos de concentración por tipo de crédito...</p>
              </div>
            </div>
          </section>
        } @else {
...
export class HHITipoCreditoComponent implements OnInit {
  ...
  async cargarDatos() {
    ...
    try {
      const datos = await this.carteraRepository.getHHITipoCredito();
  ...
  getTotalOperaciones(tipos: ConcentracionAgencia[]): number {
    return tipos.reduce((total, tipo) => total + tipo.numeroOperaciones, 0);
  }
}
