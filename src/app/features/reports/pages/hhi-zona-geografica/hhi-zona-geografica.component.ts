...
@Component({
  selector: 'app-hhi-zona-geografica',
  standalone: true,
  imports: [
    CommonModule,
    CardModule,
  ...
  template: `
    <app-hhi-navigation activeReport="zona-geografica" />
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2 lg:col-span-1">
                  <div class="kpi-card kpi-info">
                    ...
                    <div class="kpi-content">
                      <div class="kpi-header">
                        <h3 class="kpi-label">zonas de Crédito</h3>
                        <i
                          class="pi pi-info-circle kpi-help"
                          pTooltip="Número total de zonas de crédito con cartera activa. Más zonas puede indicar mejor diversificación del propósito de los créditos."
                          tooltipPosition="top"
                        ></i>
                      </div>
                      ...
                      <p class="kpi-description">zonas con cartera activa</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="analytics-card">
              <div class="card-header">
                ...
                <p class="section-subtitle">
                  Distribución y ranking de participación por zona geográfica
                </p>
              </div>
                ...
                <p-tabpanel value="0">
                  <ng-template #header>
                    <div class="flex items-center gap-2">
                      <i class="pi pi-chart-pie"></i>
                      <span>Distribución por Zona Geográfica</span>
                    </div>
                  </ng-template>
            ...
            <div class="analytics-card" style="margin-top: 2rem;">
              ...
              <div class="table-container">
                ...
                >
                    ...
                    <tr>
                      <th pSortableColumn="agencia">
                        <div class="flex align-items-center">
                          <span class="font-semibold">Zona Geográfica</span>
                  ...
                  <ng-template pTemplate="body" let-zona let-i="rowIndex">
                    <tr>
                      <td>
                        <div class="flex align-items-center gap-2">
                          ...
                          <span class="font-medium">{{ zona.agencia }}</span>
                          @if (i < 3) {
                      ...
                      <td class="text-right">
                        <span class="font-mono font-semibold amount-text">
                          {{ zona.monto | currency: 'PEN' : 'S/. ' : '1.0-2' : 'es-PE' }}
                        </span>
                      </td>
                      <td class="text-right">
                        <div class="participation-cell">
                          <div class="participation-bar">
                            <div
                              ...
                              [style.width.%]="zona.participacion"
                            ></div>
                          </div>
                          <span class="font-mono font-semibold">
                            {{ zona.participacion | number: '1.2-2' : 'es-PE' }}%
                          </span>
                        </div>
                      </td>
                      <td class="text-right">
                        <span class="font-mono">{{
                          zona.numeroOperaciones | number: '1.0-0' : 'es-PE'
                        }}</span>
                      </td>
                      <td class="text-center">
                        <span
                          ...
                          [attr.data-level]="
                            zona.participacion >= 25
                              ? 'high'
                              : zona.participacion >= 15
                                ? 'medium'
                                : 'low'
                          "
                        >
          ...
          <section class="hero-section">
            <div class="loading-state">
              <div class="loading-content">
                ...
                <p class="loading-text">Procesando datos de concentración por zona geográfica...</p>
              </div>
            </div>
          </section>
        } @else {
...
export class HHIZonaGeograficaComponent implements OnInit {
  ...
  async cargarDatos() {
    ...
    try {
      const datos = await this.carteraRepository.getHHIZonaGeografica();
  ...
  private actualizarGraficos(datos: HHIAgenciasReporte) {
    ...
    this.pieChartOptions.set({
      title: {
        text: 'Distribución por Zona Geográfica',
        left: 'center',
        textStyle: {
          fontSize: 16,
          fontWeight: 'bold',
      ...
      toolbox: {
        ...
        feature: {
          ...
          saveAsImage: {
            ...
            name: 'HHI_ZonaGeografica_Distribucion',
            pixelRatio: 2,
          },
        },
        right: 20,
      ...
      toolbox: {
        ...
        feature: {
          ...
          saveAsImage: {
            show: true,
            title: 'Descargar imagen',
            name: 'HHI_ZonaGeografica_Ranking',
            pixelRatio: 2,
          },
        },
        right: 20,
  ...
  getTotalOperaciones(zonas: ConcentracionAgencia[]): number {
    return zonas.reduce((total, zona) => total + zona.numeroOperaciones, 0);
  }
}
