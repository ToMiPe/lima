...
@Component({
  ...
  template: `
    <app-hhi-navigation activeReport="plazo" />
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="md:col-span-2 lg:col-span-1">
                  <div class="kpi-card kpi-info">
                    ...
                    <div class="kpi-content">
                      <div class="kpi-header">
                        <h3 class="kpi-label">plazos de Crédito</h3>
                        <i
                          class="pi pi-info-circle kpi-help"
                          pTooltip="Número total de plazos de crédito con cartera activa. Más plazos puede indicar mejor diversificación del propósito de los créditos."
                          tooltipPosition="top"
                        ></i>
                      </div>
                      ...
                      <p class="kpi-description">plazos con cartera activa</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="analytics-card">
              <div class="card-header">
                ...
                <p class="section-subtitle">
                  Distribución y ranking de participación por número de cuotas
                </p>
              </div>
                ...
                <p-tabpanel value="0">
                  <ng-template #header>
                    <div class="flex items-center gap-2">
                      <i class="pi pi-chart-pie"></i>
                      <span>Distribución por Número de Cuotas</span>
                    </div>
                  </ng-template>
            ...
            <div class="analytics-card" style="margin-top: 2rem;">
              ...
              <div class="table-container">
                ...
                >
                    ...
                    <tr>
                      <th pSortableColumn="agencia">
                        <div class="flex align-items-center">
                          <span class="font-semibold">Número de Cuotas</span>
                  ...
                  <ng-template pTemplate="body" let-plazo let-i="rowIndex">
                    <tr>
                      <td>
                        <div class="flex align-items-center gap-2">
                          ...
                          <span class="font-medium">{{ plazo.agencia }}</span>
                          @if (i < 3) {
                      ...
                      <td class="text-right">
                        <span class="font-mono font-semibold amount-text">
                          {{ plazo.monto | currency: 'PEN' : 'S/. ' : '1.0-2' : 'es-PE' }}
                        </span>
                      </td>
                      <td class="text-right">
                        <div class="participation-cell">
                          <div class="participation-bar">
                            <div
                              ...
                              [style.width.%]="plazo.participacion"
                            ></div>
                          </div>
                          <span class="font-mono font-semibold">
                            {{ plazo.participacion | number: '1.2-2' : 'es-PE' }}%
                          </span>
                        </div>
                      </td>
                      <td class="text-right">
                        <span class="font-mono">{{
                          plazo.numeroOperaciones | number: '1.0-0' : 'es-PE'
                        }}</span>
                      </td>
                      <td class="text-center">
                        <span
                          ...
                          [attr.data-level]="
                            plazo.participacion >= 25
                              ? 'high'
                              : plazo.participacion >= 15
                                ? 'medium'
                                : 'low'
                          "
                        >
            ...
            <div class="loading-state">
              <div class="loading-content">
                ...
                <p class="loading-text">
                  Procesando datos de concentración por número de cuotas...
                </p>
              </div>
            </div>
          </section>
...
export class HHIPlazoComponent implements OnInit {
  ...
  async cargarDatos() {
    ...
    try {
      const datos = await this.carteraRepository.getHHIPlazo();
  ...
  getTotalOperaciones(plazos: ConcentracionAgencia[]): number {
    return plazos.reduce((total, plazo) => total + plazo.numeroOperaciones, 0);
  }
}
